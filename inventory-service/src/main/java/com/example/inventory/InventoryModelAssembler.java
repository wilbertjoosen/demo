...
@Component
class InventoryModelAssembler implements RepresentationModelAssembler<InventoryItem, EntityModel<InventoryItem>> {
    ...
    CollectionModel<EntityModel<InventoryItem>> toCollectionModel(Iterable<InventoryItem> items, String productId) {
