...
public class ReportingTopology {
    ...
    static final String ORDER_METRICS_STORE = "order-metrics-store";
    static final String PRODUCT_REFS_STORE = "product-refs-store";
    static final String USER_REGISTRATIONS_STORE = "user-registrations-store";
